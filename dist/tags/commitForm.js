riot.tag2('commit-form', 'title:<br> <input type="text" ref="title"><br> description:<br> <textarea ref="desc"></textarea><br> <button onclick="{click}">commit</button>', '', '', function(opts) {
this.click = function() {
  var today = new Date();
